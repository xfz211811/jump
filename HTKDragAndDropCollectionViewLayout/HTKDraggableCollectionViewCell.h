...
- (BOOL)userCanEditCell:(UICollectionViewCell *)cell;
@end

@protocol HTKVCCollectionViewCellDelegate <NSObject>
@optional
- (void)userDidEndDraggingCell:(UICollectionViewCell *)cell;
...
@property (nonatomic, weak) id<HTKVCCollectionViewCellDelegate> vcDelegate;
